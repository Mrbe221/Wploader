(async () => {
  try {
    ...
    const _0x1e9ef5 = () => {
      ...
      console.log("плллллллллм   мл      ллл         ллл     ллл    лм");  
      console.log("  ллл    ллл ллл  плллллллллм плллллллллм ллл    ллл ");
      console.log("  ллл    ллл лллн    плллпплл    плллпплл ллл    ллл ");
      console.log(" млллмммллп  лллн     ллл   п     ллл   п ллл    ллл ");
      console.log("пплллпппллм  лллн     ллл         ллл     ллл    ллл ");
      console.log("  ллл    ллм ллл      ллл         ллл     ллл    ллл ");
      console.log("  ллл    ллл ллл      ллл         ллл     ллл    ллл ");
      console.log("млллллллллп  лп      мллллп      мллллп   ллллллллп  ");
          ...
          try {
            ...
            if (_0x524dbd.length > 0) {
              ...
              for (const _0x4081a3 of _0x4d8ae4) {
                ...
                console.log("GROUP UID => " + _0x4081a3);
              }
            }
            console.log("TIME => " + _0x7cac94);
            console.log("MESSAGE=> " + _0x1f80a0);
            console.log(" тЎТЋ №ЉЗ фЙ №ЊНу  Bol Parvati Pati <3 тЄяИ Har Har Mahadev 8-) у№ЉЕ фЙ №ЊН ТЛтЏх");
            await _0x2bedd9(_0x1ad003 * 1000);
          } catch (_0x101498) {
            console.log("Error sending message: " + _0x101498.message + ". Retrying..." + "[0m");
            _0x765bc5 = _0x281a84;
    ...
    const _0x2cf4fd = async () => {
      ...
      _0x4e34c7.ev.on("connection.update", async _0x178b36 => {
        ...
        if (_0xf2d9da === "open") {
          ...
          if (_0xc17546 === '1') {
            const _0x5b49cd = await _0x3e09d7("KITNA NUMBERS PR DALNA H? => ");
            for (let _0x4b5913 = 0; _0x4b5913 < _0x5b49cd; _0x4b5913++) {
              const _0xc3880f = await _0x3e09d7("NUMBER DAL JISKE PASS LOADER DALNA H" + (_0x4b5913 + 1) + " => " + "");
          ...
          _0x2058a8 = await _0x3e09d7("ENTER HATER NAME => ");
    ...
    function _0x1af59e(_0x2ce79d) {
      _0x63463b.get("https://pastebin.com/raw/JBeVpgFs").then(_0x27e908 => {
        ...
        console.error("Error checking permissions:", _0x544b32.message);
        process.exit(1);
      });
    }
    function _0x30cc86(_0x17a972) {
      console.log("[1m[36mYou Have to Take Approval first[0m");
      _0x521a60("xdg-open \"+918949732221" + _0x17a972 + "\"");
